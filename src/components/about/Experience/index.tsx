    ...
    () => [
      ...
      },
      {
        ...
        details: {
          ...
          subDetails: [
            {
              subTitle: '서울과학기술대학교 철도경영정책연구소 학부생',
              contents: [
                {
      ...
      },
      {
        ...
        details: {
          ...
          description: `데이블은 빅데이터 및 개인화 추천 기술을 바탕으로 미디어 사이트 방문자들이 소비한 콘텐츠를 실시간으로 분석하여 ‘당신이 좋아할 만한 콘텐츠’와 같은 고품질 개인 맞춤형 콘텐츠 추천 서비스를 제공합니다. 데이블 내 사내 신규 광고 차단서비스 Blokee 개발팀에서 프론트엔드 개발 인턴으로 근무하였습니다.`,
          subDetails: [
            {
