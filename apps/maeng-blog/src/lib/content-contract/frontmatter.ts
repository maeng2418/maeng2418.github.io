// frontmatter 직렬화/파싱 — SPEC-MAENGV2-EDITOR-MERGE-006 REQ-MERGE-004 / REQ-MERGE-005
...
// @MX:ANCHOR: [AUTO] 에디터 저장 경로의 단일 직렬화 지점 — GitHub 커밋 저장(M3)·라운드트립 테스트가 모두 이 함수를 소비
